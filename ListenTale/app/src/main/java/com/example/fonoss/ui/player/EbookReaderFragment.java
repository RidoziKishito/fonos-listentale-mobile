    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            if (currentBook != null) {
                ...
                // Æ¯u tiÃªn náº¡p tá»« mÃ¡y (Cá»°C NHANH cho sÃ¡ch Ä‘Ã£ download)
                ...
                if (localBook != null && localBook.getChapters() != null && !localBook.getChapters().isEmpty()) {
                    ...
                    // Náº¿u sÃ¡ch truyá»n qua cÃ³ sáºµn chapters (tá»« Discover)
                    totalChapters = currentBook.getChapters().size();
                    updateChapter(false);
                } else {
                    // Cuá»‘i cÃ¹ng má»›i táº£i tá»« Firestore (chá»‰ cho sÃ¡ch chÆ°a download vÃ  náº¡p tá»« Library)
