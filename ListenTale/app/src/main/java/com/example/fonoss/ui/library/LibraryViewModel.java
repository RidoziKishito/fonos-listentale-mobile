...
public class LibraryViewModel extends ViewModel {
    ...
    @Inject
    public LibraryViewModel(UserRepository userRepository, BookRepository bookRepository) {
        this.userRepository = userRepository;
        this.bookRepository = bookRepository;
        this.db = bookRepository.getDb();
        this.mAuth = userRepository.getAuth();
    }
        ...
        db.collection("users").document(user.getUid())
                .addSnapshotListener(executor, (snapshot, e) -> {
                    if (snapshot != null && snapshot.exists()) {
                        ...
                        List<Book> newlyDownloaded = updateListFromMap(snapshot, "downloaded", downloadedBooks);
                        ...
                        if (posObj instanceof Map) bookProgressPos.postValue((Map<String, Long>) posObj);
    ...
    private void autoSyncDownloads(List<Book> remoteDownloaded) {
