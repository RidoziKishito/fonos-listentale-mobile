...
final class DownloadQueueManager {
    ...
    static synchronized DownloadQueueManager getInstance(Context context) {
        if (instance == null) {
    ...
    LiveData<Map<String, Integer>> getProgressMap() {
        return progressMap;
    }

    void enqueue(List<Book> books, String userId) {
